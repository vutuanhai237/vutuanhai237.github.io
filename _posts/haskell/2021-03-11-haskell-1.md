...
{% include image.html url="https://github.com/vutuanhai237/vutuanhai237.github.io/blob/master/assets/image/haskell/1-2-1.gif?raw=true" description="Hình 1.2.1. Một hàm số cơ bản" %}
