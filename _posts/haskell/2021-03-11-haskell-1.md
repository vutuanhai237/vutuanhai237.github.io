...
---
{% include image.html url="https://www.mvps.net/docs/wp-content/uploads/2019/06/haskell.png" description="Hình 1.1. Logo Haskell, lấy cảm hứng từ $lambda$ (chữ cái Hy Lạp)" %}
...
{% include image.html url="https://github.com/vutuanhai237/vutuanhai237.github.io/blob/master/assets/image/haskell/1-2.png?raw=true" description="Hình 1.2. Một số nguồn học Haskell" %}
