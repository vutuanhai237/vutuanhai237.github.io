...
{% include image.html url="https://github.com/vutuanhai237/vutuanhai237.github.io/blob/master/assets/image/haskell/14-2-1.png?raw=true" description="Hình 14.1. Hàm pure nhận vào một Functor và một giá trị" %}

Phương thức thứ nhất có ý nghĩa theo đúng tên của nó, pure nhận giá trị kiểu bất kì rồi trả về Functor chứa giá trị bên trong mà không thay đổi giá trị đó. Một cách hay hơn khi nghĩ về pure là nó nhận một giá trị rồi đưa vào một ngữ cảnh nào đó - một ngữ cảnh tối thiểu mà vẫn cho ra giá trị đó.
